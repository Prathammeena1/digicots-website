...
export default function ContactForm() {
  ...
  return (
    <div className="min-h-screen text-zinc-200">
      {/* Hero Image Section */}
      <div className="relative h-64 bg-gradient-to-b from-teal-900 to-black">
        <div
      ...
      <div className="px-30 py-16">
        <div className="mx-auto">
          {/* Header */}
          <div className="mb-16">
            <p className="text-gray-500 text-md mb-4">Contact us</p>
            <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4">
              <h1 className="text-7xl lg:text-8xl font-bold">Let's Talk</h1>
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div className="space-y-12">
              ...
              <div>
                ...
                <p className="text-3xl font-semibold mb-2">Info@digicots.com</p>
