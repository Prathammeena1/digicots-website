...
const HomeThirdSection = () => {
  return (
    <div className='w-full h-fit relative pointer-events-none overflow-hidden'>
      ...
      <p className='absolute top-34 left-1/2 font-bold -translate-x-1/2 z-30 text-zinc-200 text-center text-3xl '> We Squeeze Out the Best of Global Applied Marketing & Strategy to
