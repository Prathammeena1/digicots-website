  ...
  return (
    <>
      <div className="relative h-[250px] aspect-square p-8 group cursor-pointer">
        <div className="absolute z-20 top-0 left-0 right-0 bottom-0 h-full w-full bg-zinc-900 scale-y-[1.1] opacity-0 group-hover:opacity-100 rotate-0 group-hover:rotate-[-8deg]" style={{transition: 'all 0.5s cubic-bezier(0.65, 0, 0.35, 1)'}}></div>
      ...
      <div className=" px-30 mx-auto ">
        <div className="flex gap-20 items-center ">
          ...
          <div className="grid grid-cols-3 gap-1">
            <Card heading="WordPress Expert" description="more than 500 sites developed" />
            <Card heading="WordPress Expert" description="more than 500 sites developed" />
            <Card heading="WordPress Expert" description="more than 500 sites developed" />
            <Card heading="WordPress Expert" description="more than 500 sites developed" />
            <Card heading="WordPress Expert" description="more than 500 sites developed" />
