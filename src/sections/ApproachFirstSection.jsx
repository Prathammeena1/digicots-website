...
const ApproachFirstSection = () => {
  ...
  return (
    <div className="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
      <div
        ref={screen1Ref}
        className="screen1 top-0 h-[50vh] w-screen left-0 right-0 z-20 fixed bg-black"
      ></div>
      <div
        ref={screen2Ref}
        className="screen2 top-[50vh] h-[50vh] w-screen left-0 right-0 z-20 fixed bg-black"
      ></div>

      {/* Background Image/Character */}
      <div className="absolute inset-0">
        <div
          className="w-full h-full bg-gradient-to-r from-orange-400 via-orange-500 to-amber-600"
          style={{
