  ...
  const caseStudyData = [
    {
      ...
      description: "The force della knowledge, the impact della creativity, the technology. With the consulting of marketing and communication.",
          ...
          <div className=" w-[55vw]">
            {caseStudyData.map((section, index) => (
              <React.Fragment key={section.id}>
                ...
                >
                  <div className="text-8xl font-bold text-gray-600 leading-none">{section.id}.</div>
          ...
          <div className=" h-full w-full relative">
            {caseStudyData.map((section) => (
              <div 
                ...
                className={`h-[45vh] absolute ${section.position} w-full overflow-hidden transition-opacity duration-500 ${
