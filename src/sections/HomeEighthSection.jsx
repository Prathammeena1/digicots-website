...
const HomeEighthSection = () => {
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-black relative z-10 ">
      <div className="text-center my-10 py-10 relative z-10 pointer-events-none bg-black">
