...
const AboutFourthSection = () => {
  ...
  const slides = [
    {
      ...
      description:
        "The force della knowledge, the impact della creativity, the pervasiveness della technology. With the consulting of marketing and communication of Quamm, the value del your business grows in the tempo.",
    },
    {
      id: 2,
  ...
  const handleTouchEnd = (e) => {
    ...
    const dragDistance =
      e && e.changedTouches
        ? Math.abs(e.changedTouches[0].pageX - touchState.current.startX)
        : 0;
    const threshold = 30;
    const container = sliderRef.current;
    const firstSlide = container.querySelector(".slide-item");
    ...
    <div className="section min-h-screen w-full text-white pt-16">
      <div className="w-full mx-auto">
        ...
        <h2 className="text-7xl font-semibold mb-6 px-30">
          <TextAnimH1>How we started</TextAnimH1>
        </h2>
                ...
                >
                  ...
                  <div className="relative w-full h-[70vh]">
                    <div className="rounded-lg h-full flex items-center justify-center transform shadow-2xl relative overflow-hidden">
                      <div className="rounded-lg w-full h-full flex items-center justify-center overflow-hidden">
                        <img
                          ...
                          className={`w-full h-full object-cover rounded-lg transition-transform duration-500 ${
                            hoveredSlide === index ? "scale-105" : "scale-100"
                          }`}
                          onError={(e) => {
                      ...
                      <div
                        className={`absolute h-fit w-[40vw] rounded-2xl inset-0 bg-white/10 backdrop-blur-2xl transition-opacity duration-500 ease-in-out flex items-end justify-start p-6 my-6 mx-6 ${
                          hoveredSlide === index ? "opacity-100" : "opacity-0"
                        }`}
                      >
                        <div
                          className={`text-white transform transition-transform duration-500 w-full ease-out ${
                            hoveredSlide === index
                              ? "translate-y-0"
                              : "translate-y-4"
                          }`}
